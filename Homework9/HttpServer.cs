...
public class HttpServer
{
    ...
    public HttpServer(string currentDirectory)
    {
    ...
    public async Task Start()
    {
        ...
        Console.WriteLine($"http://{_serverData.AppSettings.Configuration!.Address}:{_serverData.AppSettings.Configuration.Port}/");
